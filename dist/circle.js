...
function callOption(value) {
  if (value == 1) {
    ...
    $('.ui.modal').modal('show');
    document.getElementById("description").innerHTML = "<body id='bodyv2'><h1 style='font-size:30px; color:white; text-align:center;'> Special Programs </h1><hr><p style='text-align:center;color:white; font-size:18px;'><b>Girls Who Code:</b> A highly competitive summer immersion program that is working to end the gender gap in the stem field by teaching girls about the Computer Science field and motivating them to pursue STEM studies.<br> <a href='http://girlswhocode.com/'>Visit there page!</a> </p><div class='container'><table><tr><div style='width;color:white; width:80%;margin: auto; height:250;'><p><img src="gwcgs.jpg" class="img-thumbnail" width="40%" height="20%" > <p style='margin: 0;padding: 0; font-size:30px'> Girls Who Code - Natalia</p><p style='margin: 0;padding: 0; font-size:15px'> Goldman Sachs 2014 </p><p style='margin: 0;padding: 0; font-size:20px'> /Summary about their experience/ </p></p></div></tr><tr><div style='color:white; width:80%;margin: auto; height:250;'><p><img src="gwcan.jpg" class="img-thumbnail" width="40%" height="20%" align='right'> <p style='margin: 0;padding: 0; font-size:30px'> Girls Who Code - Kirstyn</p><p style='margin: 0;padding: 0; font-size:15px'> Goldman Sachs 2014 </p><p style='margin: 0;padding: 0; font-size:18px'> /Summary about their experience/ </p></p></div></tr></table></div></body>";
  } else if (value == 4) {
    $('.ui.modal').modal('show');
    ...
    $('.ui.modal').modal('show');
    document.getElementById("description").innerHTML = "<h1 style='font-size:30px; color:black; text-align:center;'> Software </h1><hr><p style='font-size:18px; color:black; text-align:center;'> While learning programming languages, students are not tied down to only using one developing platform. These are some that are mainly used in the classroom but are not limited to.</p><div class='container'><table style='width:80%' align='center'><tr><td><div class='flip-container' ontouchstart='this.classList.toggle('hover');'><div class='flipper'><div class='front'>Scratch</div><div class='back'><img src='scratch.jpg' style='width:100%; height:100%;'></div></div></div></td><td><div class='flip-container' ontouchstart='this.classList.toggle('hover');'><div class='flipper'><div class='front'>Eclipse</div><div class='back'><img src='eclipse.jpg' style='width:100%; height:100%;'></div></div></div></td><td><div class='flip-container' ontouchstart='this.classList.toggle('hover');'><div class='flipper'><div class='front'>Sublime</div><div class='back'><img src='sublime.jpg' style='width:100%; height:100%;'></div></div></div></td></tr></table></div>";
  } else if (value == 6) {
    $('.ui.modal').modal('show');
