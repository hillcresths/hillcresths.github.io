...
function callOption(value) {
  if (value == 1) {
    ...
    $('.ui.modal').modal('show');
     document.getElementById("description").innerHTML = "<center> <p style='font-size:20px; color:#161673;'> <img src='../assets/images/languages.png' align='left' style= 'width:25%' > <b style='font-size:40px; color:#161673;'> Languages: </b> <br> <br> <b style='font-size:25px;'> HTML </b> - Hyper Text Markup Language <br> <b style='font-size:25px;'> Java </b> -  object-oriented language similar to C++, but simplified to eliminate language features that cause common programming errors. <br> <b style='font-size:25px;'> JavaScript </b> - is the programming language of HTML and the Web. <br> <b style='font-size:25px;'> Scratch </b> - a free programming language and online community where you can create your own interactive stories, games, and animations.</p> </center>";
  } else if (value == 3) {
    $('.ui.modal').modal('show');
