...
function callOption(value) {
  if (value == 1) {
    ...
    $('.ui.modal').modal('show');
    document.getElementById("description").innerHTML = "<center> <p style='font-size:25px; color:#161673;'> <b style='font-size:30px; color:#161673;'> Resources/Internships: </b> <br> Fabberz, Tietz-Baccon </p> <br> <img src='../assets/images/interships.png' > </center>";
  } 
}
